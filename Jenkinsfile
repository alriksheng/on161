pipeline {
  parameters {
    ...
    string(defaultValue: 'on183_insertfrom161.sql', description: 'SQL_FILE', name: 'SQL_FILE')
    string(defaultValue: 'on183_insertfrom161_temp.sql', description: 'SQL_FILE_TEMP', name: 'SQL_FILE_TEMP')
