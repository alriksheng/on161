pipeline {
  parameters {
    ...
    string(defaultValue: 'on161_cleanup.sql', description: 'SQL_FILE', name: 'SQL_FILE')
    string(defaultValue: 'on161_cleanup_temp.sql', description: 'SQL_FILE_TEMP', name: 'SQL_FILE_TEMP')
