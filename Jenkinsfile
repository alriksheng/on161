  ...
  stages {
    ...
    stage("2nd schema check") {
      steps {
        script{
          // to int
          def data_mth_int = params.DATA_d1 as Integer
        ...
        // execute
        sh "python ${params.FILE_PATH_PY}/${params.PYTHON_FILE2} ${params.FILE_PATH_SQL}/${params.SQL_FILE} ${params.USERNAME_161} ${params.DATABASENAME_161}" //本地
      }
    }
  }
}
