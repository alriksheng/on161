pipeline {
  parameters {
    ...
    string(defaultValue: 'on161_gaodexdrday.sql', description: 'SQL_FILE', name: 'SQL_FILE')
    string(defaultValue: 'on161_gaodexdrday_temp.sql', description: 'SQL_FILE_TEMP', name: 'SQL_FILE_TEMP')
